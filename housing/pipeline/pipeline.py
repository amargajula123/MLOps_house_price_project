...
# main Thread is responsible for run your entire application
# here we forking 1 Thread from the main. we actually creating one branch from the Thread.
# that will take care of your execution of your training. and it is independent to the main Thread.
