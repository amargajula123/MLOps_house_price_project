...
class ModelTrainer:
    ...
    def __del__(self):
        ...
        # reading model config yaml file
        # getting best model on training dataset
        # evaluating models on both training & testing dataset --> model object
        # loading preprosesing object

             ## we created custom model 
        # custom model object by combining both, preprosesing object and model object (model_trained obj)
        # saving custome model object 

        # retern model_trainer_artifact
